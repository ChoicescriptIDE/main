...
if (process.platform === "darwin") {
    installFolderPath = process.execPath.substring(0, process.execPath.lastIndexOf('Versions')) + "Resources/";
...
function getUpdateDetails(channel, cb) {
    var ca = fs.readFileSync(path.join(__dirname, 'cacert.pem'));
    var agent = new https.Agent({
        ca: ca
    });
    var request = https.get({ agent: agent, hostname: 'choicescriptide.github.io', path: '/downloads/updates/version.js' }, function(response) {
